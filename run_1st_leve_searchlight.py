...
#SBATCH --mem=40G
#SBATCH --time=2:00:00
#SBATCH --output=/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/work_flows/firstLevel/searchlight_{task}_sub_{sub}_%j.out
#SBATCH --error=/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/work_flows/firstLevel/searchlight_{task}_sub_{sub}_%j.err


module load apptainer
apptainer exec -B /gscratch/fang:/data -B /gscratch/scrubbed/fanglab/xiaoqian:/scrubbed_dir {container_path} \\
    python3 /app/run_1st_level_searchlight.py --subject {sub} --task {task}
"""
    script_path = os.path.join(work_dir, f'searchlight_sub_{sub}_slurm.sh')
